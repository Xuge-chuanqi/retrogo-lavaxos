...
static const char *SETTING_BACKLIGHT_ENABLED = "DispBacklightEnabled";
...
#elif RG_SCREEN_DRIVER == 2 /* ST7735 */
#include "drivers/display/st7735.h"
#elif RG_SCREEN_DRIVER == 3 /* UC1611S */
#include "drivers/display/uc1611s.h"
...
void rg_display_set_backlight(display_backlight_t percent)
{
    ...
    rg_settings_set_boolean(NS_GLOBAL, SETTING_BACKLIGHT_ENABLED, true);
...
void rg_display_toggle_backlight(void)
{
    backlight_enabled = !backlight_enabled;
    rg_settings_set_boolean(NS_GLOBAL, SETTING_BACKLIGHT_ENABLED, backlight_enabled);
    rg_settings_commit();
    lcd_set_backlight(backlight_enabled ? config.backlight : 0);
}

void rg_display_set_contrast(uint8_t contrast)
{
#if RG_SCREEN_DRIVER == 3
...
void rg_display_init(void)
{
    ...
    backlight_enabled = rg_settings_get_boolean(NS_GLOBAL, SETTING_BACKLIGHT_ENABLED, true);
    lcd_init();
